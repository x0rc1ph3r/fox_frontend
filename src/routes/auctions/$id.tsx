...
function AuctionDetails() {
  ...
  const isFavorite = getFavouriteAuction.data?.some(
  ...
  <main>
    <div className="w-full py-5 md:py-10 max-w-[1440px] px-5 mx-auto">
        <Link to={"/auctions"} className='px-6 cursor-pointer transition duration-300 hover:opacity-80 inline-flex items-center gap-2 py-2.5 bg-gray-1400 rounded-full text-base font-semibold text-black-1000'>
            ...
            <div className="w-full flex gap-6 md:gap-10 xl:flex-row flex-col">
                <div className="flex-1 max-w-full xl:max-w-[450px]">
                    ...
                    <div className="w-full pb-7 pt-6 md:py-10 hidden md:flex items-center justify-between">
                        <div className="flex items-center gap-3 2xl:gap-5">
                            ...
                            <h3 className='md:text-[28px] text-lg font-bold text-black-1000 font-inter'>{auction?.userName}</h3>
                        </div>

                        <ul className='flex items-center gap-6'>
                            <li>
                                <a href='#'><img src="/icons/twitter-icon.svg" className='w-7 h-7 object-contain' alt="" /></a>
                            </li>

                                <li>
                                <a href='#'> <img src="/icons/mcp-server-icon.svg" className='w-7 h-7 object-contain' alt="" /></a>
                            </li>
                        </ul>
                 ...
                 <div className="w-full space-y-5 hidden md:block">
                    {UserDetails.map((section, index) => (
                        ...
                        {({ open }) => (
                            <>
                            <Disclosure.Button   className={`flex items-center justify-between w-full text-base md:text-xl font-bold font-inter text-black-1000 ${
                            ...
                            <Disclosure.Panel className="w-full">
                                ...
                                {section.items.map((item) => (
                                    ...
                                    <p className="md:text-base text-sm font-inter font-medium text-black-1000">{item.value}</p>
                                    </li>
                                ))}
                                </ul>
                            </Disclosure.Panel>
                ...
                <div className="flex-1">
                    <div className="w-full">
                        ...
                        <h1 className='md:text-[28px] text-xl font-inter md:mt-6 my-5 md:mb-5 font-bold text-black-100'>{auction?.heading}</h1>
                        <div className="flex items-start md:items-center md:flex-row flex-col md:gap-0 gap-5 justify-between pb-6 md:pb-8 border-b border-gray-1100">
                           ...
                           <ul className="flex items-center gap-4 md:gap-3 2xl:gap-5">
                                ...
                                <li>
                                <button className="border cursor-pointer px-5 py-[7px] md:py-2.5 gap-2.5 border-black-1000 rounded-full text-sm md:text-base font-semibold font-inter text-black-1000 inline-flex items-center justify-center">
                                    <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width={24}
                                    height={24}
                          ...
                          Auction winner
                            ...
                            <div className="w-full">
                                ...
                                <li key={index}>
                                    ...
                                    } className={`md:text-base whitespace-nowrap text-sm cursor-pointer font-inter font-medium transition duration-300 hover:bg-primary-color text-black-1000 rounded-full py-2.5 md:py-3.5 md:px-5 px-3 ${tab.active ? 'bg-primary-color' : 'bg-gray-1400'}`}>{tab.name}</button>
                                </li>
                                ))}
