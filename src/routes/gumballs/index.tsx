                ...
                <div className="flex-1 flex items-center justify-between lg:gap-10 gap-5 flex-col lg:flex-row">
                  ...
                  <ul className="flex items-center sm:justify-center md:justify-start justify-start md:gap-5 gap-3">
                    {["Featured", "All Gumballs", "Past Gumballs"].map((f, index) => (
                      <li key={index}>
                        <button onClick={() => setFilter(f)} className={`md:text-base whitespace-nowrap text-sm cursor-pointer font-inter font-medium transition duration-300 hover:bg-primary-color text-black-1000 rounded-full py-2.5 md:py-3.5 px-4
                    ...
                    <div className="lg:py-10 py-5 flex items-center gap-4">
                        ...
                        {filter && 
                        <>
                        <p className="md:text-base text-sm whitespace-nowrap font-black-1000 font-semibold font-inter">Filters :</p>
                        <ul className="flex items-center gap-4">
                          <li>
                            <div className="border group hover:border-black-1000 transition duration-200 h-12 inline-flex items-center justify-center rounded-full border-gray-1100 px-5 py-3 gap-2">
                              <p className="md:text-base whitespace-nowrap text-sm font-inter font-medium text-black-1000">Clear All</p>
                              <button onClick={()=>setFilter('')} className="cursor-pointer"><img src="/icons/cross-icon.svg" className='min-w-4' alt="cross icon" /></button>
                            </div>
                          </li>
            
                              <li>
                            <div className="border group hover:border-black-1000 transition duration-200 h-12 inline-flex items-center justify-center rounded-full border-gray-1100 px-5 py-3 gap-2">
                              <p className="md:text-base whitespace-nowrap text-sm font-inter font-medium text-black-1000">nft Raffles</p>
                              <button className="cursor-pointer"><img src="/icons/cross-icon.svg" className='min-w-4' alt="cross icon" /></button>
                            </div>
                          </li>
            
                              <li>
                            <div className="border group hover:border-black-1000 transition duration-200 h-12 inline-flex items-center justify-center rounded-full border-gray-1100 px-5 py-3 gap-2">
                              <p className="md:text-base whitespace-nowrap text-sm font-inter font-medium text-black-1000">Past Raffles</p>
                              <button className="cursor-pointer"><img src="/icons/cross-icon.svg" className='min-w-4' alt="cross icon" /></button>
                            </div>
                          </li>
                        </ul>
